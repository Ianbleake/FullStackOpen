    ...
    <div className={`blog ${drop ? 'droped' : ''}`}>
      <div className="info">
        ...
        <div className={`fullinfo ${drop ? 'droped' : ''}`}>
          <p className='ifo'>
            Autor: <span id='autor' className='if'>{blog.author}</span>
          </p>
          <p className='ifo'>
            Link: <span id='url' className='if'>{blog.url}</span>
          </p>
          <p className='ifo'>
            Usuario: <span id='user' className='if'>{blog.user.name}</span>
          </p>
          <button data-testid='like' className="Btn" onClick={handleLike}>
            ...
            <span data-testid='likescount' id='likes' className="likeCount">
              {blog.likes}
            </span>
          </button>
        </div>
      ...
      <div className="ctas">
        <label className="label">
          <div className="toggle">
            <input data-testid='switch' onClick={handleDrop} className="toggle-state" type="checkbox" name="check" value="check" />
